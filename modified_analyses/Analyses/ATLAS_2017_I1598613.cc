...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      if (_mode == 0) {
        ...
        DressedLeptons dressedmuons(photons, muons, 0.1, eta_lep && (Cuts::pT >= 6*GeV), true, true);
    ...
    void analyze(const Event& event) {
      ...
      if (_mode == 0) { // the 3-muon-level analysis
        ...
        //first, simple check that we have enough muons:
        ...
        //should now have the full list of 3rd muons to consider.
    ...
    void applyTransferFnAndNorm(HistoHandler handler) {
  ...
  class  ATLAS_2017_I1598613_BB : public  ATLAS_2017_I1598613 {
  public:
     ATLAS_2017_I1598613_BB()
      :  ATLAS_2017_I1598613("ATLAS_2017_I1598613_BB")
    {
      _mode = 1;
    }
  };
