...
parser = ArgumentParser(description=(
    ...
    "Produces a scan directory containing: all files in given grid pack, a "
    "parameters file detailing the parameters used at that run point and a "
    "shell script to run Herwig that is then submitted to batch.\n"),
...
parser.add_argument("-g", "--grid", dest="grid_pack", type=str,
                    ...
                    help=("Provide additional gridpack. Set to 'none' to not "
                          "use one."))
parser.add_argument("-N", "--numevents", dest="num_events", default='10000',
                    metavar='num_events',
...
pwd = os.getcwd()
for directory in os.listdir(args.out_dir):
    directory_name = os.path.join(args.out_dir, directory)
