...
import yoda
import rivet
import contur.Utils as newu
import contur.TestingFunctions as newctr
import TesterFunctions as ctr
...
#
    ...
    normalised, factor, scaleMC = newctr.isNorm(h)
