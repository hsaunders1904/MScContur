...
and (iii) an `intermediate' scenario $\GQ = 0.375, \GDM = 1$, between the two. We also consider (iv) a scenario where the coupling of DM to the mediator is
...
sufficiently model-independent fashion that it has the same sensitivity to the $l^+l^- +$ DM channel. This is illustrated in Fig.~\ref{fig:ATLASzz}. 
...
For the first three scenarios, at $\MZP > 2\MDM$ the decay of the mediator to Dark Matter dominates of the decay to jets. This leads to the diagonal structure across the plots, 
...
enough that the diagonal cutoff in sensivitivty of the jet channels at $\MZP \approx 2\MDM$ is blurred. 
...
over the decay to quarks. Hence the sensivity in the inclusive jet (and $V+$jet) signatures drops in all scenarios except the fourth. 
...
comes from the $l^+l^- + \MET$ measurement, and dies away at $\MZP \approx 750$~GeV. In the fourth scenario, the decays to DM are relatively suppressed and 
...
\centering
    \subfloat[$\GQ=0.25$ and $\GDM = 1$ \label{fig:cont025}]{%
      \includegraphics[width=0.5\textwidth]{analysis/contours/gq025_contour.pdf}
    }
    \subfloat[$\GQ=0.5$ and $\GDM = 1$\label{fig:cont05}]{%
      \includegraphics[width=0.5\textwidth]{analysis/contours/gq05_contour.pdf}
    }

    \subfloat[$\GQ=0.375$ and $\GDM = 1$\label{fig:cont0375}]{%
      \includegraphics[width=0.5\textwidth]{analysis/contours/gq0375_contour.pdf}
    }
    \subfloat[$\GQ=0.375$ and $\GDM = 0.25$\label{fig:cont0375_025}]{%                
      \includegraphics[width=0.5\textwidth]{analysis/contours/gq0375_gdm025_contour.pdf}
    }
