...
To simulate the experimental signature for our model, we have encoded the model Lagrangian in \textsc{FeynRules}~\cite{Alloul:2013bka}. Using its UFO interface~\cite{Degrande:2011ua},
a BSM configuration is created for Herwig~7~\cite{Bellm:2015jjp,Bahr:2008pv}. For each parameter point in the scan grid, \todo{NNN} events were generated and analysed using the 
 \rivet library~\cite{Buckley:2010ar}. Calculation of the exclusion contours was done in Python scripts, available on the \Contur website \url{https://contur.hepforge.org/}

\todo{DY please fill in version numbers of the tools}. 
