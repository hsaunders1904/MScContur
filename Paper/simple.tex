...
\caption{Feynman diagrams introduced by the simplified model at leading order. (a) $s$-channel production followed by decay to quarks or to DM, (b) associated jet production (c) associated gauge-boson production.}\label{fig:feyndia}
\end{figure}
