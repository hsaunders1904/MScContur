...
\section{Strategy and Statistical Method}
...
be the width of a Gaussian spread, and we use the asymptotic statisitcal techniques described in Cowan, Cranmer and Gross~\cite{Cowan:2010js} to derive
...
the rivet output, we select data sets to minimise their impact, as described below, and then combine the selected data to obtain an overall exclusion probability
...
signal which might in principle arise as the cumulative effect of a number of statistically insiginificant deviations across a range of experimental measurements.
