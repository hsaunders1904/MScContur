...
\includegraphics[width=1.0\textwidth]{images/map_gq_25_gdm_1.pdf}
\caption{A heatmap displaying the combined confidence level of exclusion of the $\mu = 1$ full signal strength hypothesis, 
calculated as outlined in section \ref{subsec:statmethod} and taking into account the array of possible measurements as covered
