...
\centering
\subfloat{
\includegraphics[width=0.5\textwidth]{images/feyndia/vec_dm_born.pdf}\label{fig:schannel}
}
\subfloat{
\includegraphics[width=0.5\textwidth]{images/feyndia/vec_dm_g.pdf}\label{fig:plusjet}
}
\subfloat{
\includegraphics[width=0.5\textwidth]{images/feyndia/vec_dm_weak.pdf}\label{fig:plusV}
}
...
\todo{JB to sort this out... MK: maybe we should show a couple of example Feynman diagrams at some point? JMB: I think that would be very good 
