...
models to be placed, using existing and future measurements. We demontrate, using a competitive 
simplified Dark Matter model, the power of this approach. The method is highly scaleable to other models and future measurements.
\end{abstract}
