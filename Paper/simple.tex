...
against data this way. If no BSM physics emerges, a model-independent and systematic approach becomes mandatory.
...
The sensitivities derived from multiple distribiutions such as those discussed in the previous section are combined into `heatmaps' which delineate exclusion 
...
To the top left region of the diagonal the decay of the mediator to Dark Matter is kinematically allowed, and for the chosen value of $\GDM=1$ it will dominate 
...
in the intermediate and challenging scenarios. 
...
\centering
    ...
    \subfloat[$\GQ=0.375$ and $\GDM = 0.25$\label{fig:map0375_025}]{%                                                               
      \includegraphics[width=0.5\textwidth]{images/combinedCL_gq0375_gdm025.pdf}
    }
...
{\bf here we should have some discussion of the theory constraints, other experiment constraints, and cosmological context. Contour plots to come from DY?}
...
for models of new physics and hopefully narrowing the focus of experimental and theoretical effort on to the best models. It is this complementary to 
...
One notable feature is the simultaneous coverage of a wide variety final states. This leads to enhanced stability of the sentivity as a function of model
parameters, and also can uncover sensitivity in channel which might not otherwise be considered. For example, in our case unexpected sensitivity is seen in
...
Josh McFayden, Les Houches, Michele Massimi... STFC... MCnet
