...
%%Insert some text like the following in these captions
%%The generated BSM process cross section is constructed as per, and represented alongside, the measured data (left) and the ratio of data plus BSM simulation to data is also presented (right).
...
\centering
    ...
    \caption{ Outputs from \textsc{Rivet} for a potential measurement to be included in the limit setting process. Simulated signals for a sample of mediator masses, interpreted as perturbations to the double differential inclusive jet cross section in the most central rapidity region, binned by dijet mass and rapidity corresponding to the data as measured by ATLAS at 7 TeV~\cite{Aad:2014pua}. The signals form a 1D parameter space scan in mediator mass for fixed dark matter mass and mediator couplings; $m_{\textsc{dm}}=600$ GeV, $g_{q}=0.25$ and $g_{\textsc{dm}} = 1$. }
...
\caption{Outputs from \textsc{Rivet} for a potential measurement to be included in the limit setting process. Simulated signals for a sample of mediator masses, interpreted as perturbations to the double differential dijet cross section in the most central rapidity region, binned by leading jet $p_{T}$ and rapidity corresponding to the data as measured by CMS at 7 TeV~\cite{Chatrchyan:2014gia}. The signals form a 1D parameter space scan in mediator mass for fixed dark matter mass and mediator couplings; $m_{\textsc{dm}}=600$ GeV, $g_{q}=0.25$ and $g_{\textsc{dm}} = 1$.}
...
\caption{Outputs from \textsc{Rivet} for a potential measurement to be included in the limit setting process. Simulated signals for a sample of mediator masses, Interpreted as perturbations to the $ZZ\rightarrow ll\nu \nu$ cross section 
corresponding to the data as measured by ATLAS at 7 TeV~\cite{Aad:2012awa} \label{fig:ATLASzz}. The signals form a 1D parameter space scan in mediator mass for fixed dark matter mass and mediator couplings; $m_{\textsc{dm}}=100$ GeV, $g_{q}=0.25$ and $g_{\textsc{dm}} = 1$.}
