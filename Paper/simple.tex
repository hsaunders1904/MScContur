...
As mentioned in section~\ref{sec:model},  the parameters of the simplified model, \GDM, \GQ, \MDM, and \MZP, are constrained by perturbative unitarity. 
The region 
\begin{equation}
\MDM \lesssim \sqrt{\frac{\pi}{2}} \frac{\MZP}{g_{\rm DM}}\,,
\end{equation}
defines the parameter space where the dark matter relic density can be reliably calculated within the simplified model, and is indicated as the blue shaded region in 
Fig.~\ref{fig:cont}. Given the 
